        ...
        stage('Docker Build') {
            steps {
                echo "Start Docker Build"
                    sh '''
                    aws ecr describe-repositories --repository-names ${process} || aws ecr create-repository --repository-name ${process} --image-scanning-configuration scanOnPush=true --region ${aws_region} 
